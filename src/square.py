...
def square_center(x, y, edge_length=1):
...
def pick_square(x, y, edge_length=1):
...
def square_line_intersect(x1, y1, x2, y2, edge_length=1):
...
def square_rect_intersect(x, y, width, height, edge_length=1):
...
def square_rect_knoll(x, y, rect_x, rect_y, width, height):
    """Given a square and a rectangle, gives a pair of integer cartesian co-ordinates that
     identify the square in the rectangle"""
